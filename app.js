...
function htmlIncidencia() {
  ...
  return `
    <div class="plano-metodo">
      ...
      <p>
        Não tem API da QConcursos nem do TEC. A gente cruza <b>edital passado</b>
        (o que estava no programa e, quando a banca publicou, o n oficial),
        <b>prova deste cargo</b> (n=1, peso da matéria nesta prova) e
        <b>caderno da banca</b> (n grande, tendência — não é esta prova).
        % de tópico só sai do caderno. Prova pequena não vira fatia de assunto.
      </p>
    </div>
    ...
    <div class="meta inc-resumo">
      <div><b>${esc(recorte.concursoNome)}</b><span>Camada 3 · caderno ${esc(recorte.banca)}</span></div>
...
function htmlCaiBloco(materiaId, concurso) {
  ...
  return `<div class="fonte-aula cai-materia">
    <p class="kicker">O que cai em ${esc(nomeMat)} · ${esc(nomeConc)} · ${esc(banca)}</p>
