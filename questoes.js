...
const MATERIAS_BASE = [
  ...
  { id: "df", nome: "Distrito Federal", sigla: "DF", cor: "#8a7a5a" },
  { id: "legedu", nome: "Legislação educacional", sigla: "Leg. edu", cor: "#8a7a5a" },
  { id: "ing", nome: "Inglês", sigla: "Inglês", cor: "#6b8fd4" },
  { id: "rlm", nome: "Raciocínio lógico", sigla: "RLM", cor: "#6b8fd4" },
  { id: "dh", nome: "Direitos humanos", sigla: "DH", cor: "#c46b5a" },
  { id: "crim", nome: "Criminologia", sigla: "Crim.", cor: "#c46b5a" },
  { id: "legispm", nome: "Legislação da PMDF", sigla: "Leg. PM", cor: "#c46b5a" },
  { id: "dfmul", nome: "DF e política para mulheres", sigla: "DF / mulh.", cor: "#8a7a5a" },
  { id: "admpub", nome: "Administração", sigla: "Adm.", cor: "#d4b45a" },
  { id: "penal", nome: "Direito penal", sigla: "Penal", cor: "#c46b5a" },
  { id: "procpen", nome: "Processual penal", sigla: "Proc. pen.", cor: "#c46b5a" },
  { id: "penex", nome: "Legislação penal extravagante", sigla: "Pen. extr.", cor: "#c46b5a" },
  { id: "penmil", nome: "Direito penal militar", sigla: "Pen. mil.", cor: "#c46b5a" },
  { id: "procpenmil", nome: "Processual penal militar", sigla: "PPM", cor: "#c46b5a" },
  { id: "fin", nome: "Direito financeiro", sigla: "D.Fin", cor: "#d4b45a" },
  { id: "legisgo", nome: "Legislação de Goiás", sigla: "Leg. GO", cor: "#8a7a5a" },
  { id: "orc", nome: "Orçamento público", sigla: "Orçam.", cor: "#d4b45a" },
  { id: "controle", nome: "Controle externo", sigla: "Controle", cor: "#d4b45a" },
